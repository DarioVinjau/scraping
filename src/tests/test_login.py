...
class TestHomePage(unittest.TestCase):
    ...
    def test_pc_romagna(self):
        try:
            ...
            self.home_page.click_element(self.home_page.marche_button)
            
            descrizione = self.home_page.get_text(self.home_page.data_asin)
            prezzo = self.home_page.get_text(self.home_page.value)
            time.sleep(5)
